...
def convert(inp, outp = None):
    ...
    if os.path.isfile(inp):
        ...
        if ext.lower() in ['.heic', '.heif']:
            ...
            subprocess.call('heif-convert "{}" "{}"'.format(inp, outp), shell=True)
            rotate_img(outp, 360)
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--data',
                        ...
                        default='/Users/dariatunina/mach-lerinig/mLStuff/photos_test/0/IMG_2898.HEIC')
    parser.add_argument('-o', '--out',
                        help='Output file/directory. Default: Same as \
                            input directory/file with .jpg extension.',
                        default=None)#'/Users/dariatunina/mach-lerinig/mLStuff/photos_test/0/IMG_2898.jpg')
