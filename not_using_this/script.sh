...
#ssh -T ${USERNAMES}"@"${HOSTS} './darknet detector test data/obj.data cfg/yolov3-full1.cfg backup-eq1/yolov3-full1_best.weights -dont_show -ext_output -out result.json < test.txt > result.txt'
