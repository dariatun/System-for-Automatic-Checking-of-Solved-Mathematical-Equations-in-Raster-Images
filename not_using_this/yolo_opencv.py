...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--labels', type=str, default='model/obj.names', help='Path to label file')
    ...
    parser.add_argument('-i', '--image_path', type=str, default='test_data/2.jpg', help='Path to the image file.')
